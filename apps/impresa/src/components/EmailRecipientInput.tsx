...
// 22/09/2026: input destinatari con autocomplete su res.partner.
// Separa le email con virgola. Scrive almeno 2 caratteri per far
// partire la ricerca; debounce 250ms; click su un risultato aggiunge
// l'email al campo e chiude il dropdown.
export default function EmailRecipientInput({ value, onChange, placeholder, className }: Props) {
    ...
    const handleKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
        ...
        if (e.key === "ArrowDown") { e.preventDefault(); setHighlight((h) => Math.min(h + 1, results.length - 1)); }
            ...
            if (r && r.email) addRecipient(r.email as string);
        ...
        <div ref={wrapRef} className="relative">
            ...
            <div className="relative">
                <input
                    ...
                    placeholder={placeholder || "Cerca nome o email…"}
